...
import { FaBook, FaBookReader, FaSwatchbook, FaUser } from 'react-icons/fa';
            ...
            <div className="drawer-side z-40">
                ...
                <ul className="menu p-4 w-80 h-full bg-base-200 space-y-5">
                    ...
                    <NavLink to='/'
                        ...
                        <FaBookReader className='w-5 h-5' /> <span className='mx-4 font-medium'>Home</span>
                    </NavLink>

                    <NavLink to='/classes'
                        className={({ isActive }) =>
                            `flex items-center px-4 py-2 mt-5 text transition-colors duration-300 transform hover:text-info hover:bg-neutral  ${isActive ? 'bg-info/30' : 'text-gray'}`}>
                        <FaBook className='w-5 h-5' /> <span className='mx-4 font-medium'>Classes</span>
                    </NavLink>

                    <NavLink to='/instructors'
                        className={({ isActive }) =>
                            `flex items-center px-4 py-2 mt-5 text transition-colors duration-300 transform hover:text-info hover:bg-neutral  ${isActive ? 'bg-info/30' : 'text-gray'}`}>
                        <FaBookReader className='w-5 h-5' /> <span className='mx-4 font-medium'>Instructors</span>
                    </NavLink>
                    ...
                    {user &&
                          ...
                          className={({ isActive }) =>
                              `flex items-center px-4 py-2 mt-5 text transition-colors duration-300 transform hover:text-info hover:bg-neutral  ${isActive ? 'bg-info/30' : 'text-gray'}`}>
                          <FaSwatchbook className='w-5 h-5' /> <span className='mx-4 font-medium'>Dashboard</span>
                      </NavLink>
                    }
                    <div
